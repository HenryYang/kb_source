...
* 換票時間點
    ...
    <tbody>
    <tr><td>最近可以訂到的票</td><td>網站 48 小時前，電話 24 小時前（如果電話客服下班就只能等上班）</td></tr>
    <tr><td>最遠可以訂到的票</td><td>第 360 天</td></tr>
    </tbody>
    </table>
...
<thead class="thead-dark"><tr><th>行李類型</th><th>尺寸限制</th><th>單邊尺寸上限</th><th>重量上限</th><th>備註</th></tr></thead>
<tbody>
<tr><td>國際線隨身行李</td><td>三邊尺寸總和不超過 115 CM</td><td>寬 55、高 40、長 25 CM</td><td>不超過 10 公斤（22 磅）</td><td>—</td></tr>
<tr><td>國際線托運行李</td><td>三邊尺寸總和不超過 203 CM</td><td>—</td><td>—</td><td>—</td></tr>
<tr><td>國內線隨身行李（超過 100 個座位的）</td><td>三邊尺寸總和不超過 115 CM</td><td>寬 55、高 40、長 25 CM</td><td>不超過 10 公斤（22 磅）</td><td>—</td></tr>
<tr><td>國內線隨身行李（少於 100 個座位的）</td><td>三邊尺寸總和不超過 100 CM</td><td>寬 45、高 35、長 20 CM</td><td>不超過 10 公斤（22 磅）</td><td>—</td></tr>
<tr><td>國內線托運行李</td><td>三邊尺寸上限: 120 x 60 x 50 CM</td><td>—</td><td>—</td><td>經濟艙限重 20Kg，頭等艙限重 45Kg，無件數限制</td></tr>
</tbody>
</table>
...
<div id="jlAirportTransferCarousel" class="carousel slide" data-ride="carousel" style="max-width: 565px;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://i.imgur.com/Tqwi9oC.jpeg" class="d-block" style="width: 100%; height: auto;" />
    </div>
    <div class="carousel-item">
      <img src="https://i.imgur.com/iRtipG5.jpeg" class="d-block" style="width: 100%; height: auto;" />
    </div>
    <div class="carousel-item">
      <img src="https://i.imgur.com/LeOFTMi.jpeg" class="d-block" style="width: 100%; height: auto;" />
    </div>
  </div>
  <a class="carousel-control-prev" href="#jlAirportTransferCarousel" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#jlAirportTransferCarousel" role="button" data-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
  <ol class="carousel-indicators">
    <li data-target="#jlAirportTransferCarousel" data-slide-to="0" class="active"></li>
    <li data-target="#jlAirportTransferCarousel" data-slide-to="1"></li>
